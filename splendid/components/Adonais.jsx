...
class Adonais extends Component {
  ...
  render({ splendid, class: className }) {
    ...
    return (<div className={`Adonais ${className}`}>
      ...
      <Letter file="img/adonais/a2.png" top={112} left={219} class={cl`A Image`} href="#art-deco" cl={cl}>
      ...
      <Letter file="img/adonais/I.png" top={208} left={175} class={cl`I Image`} href="#implementation" cl={cl}>
      ...
      <Letter file="img/adonais/A3.png" top={207} left={73} class={cl`A2 Image`} href="#automated-testing" cl={cl}>
      ...
      <Letter file="img/adonais/D.png" top={123} left={15} class={cl`D Image`} href="#documentation" cl={cl}>
      ...
      <Letter file="img/adonais/O.png" top={28} left={67} class={cl`O Image`} href="#optimisation" cl={cl}>
      ...
      <Letter file="img/adonais/N.png" top={25} left={169} class={cl`N Image`} href="#npm-packages" cl={cl}>
      ...
      <Letter file="img/adonais/S.png" top={120} left={125} class={cl`S Image`} href="#software" cl={cl}>
